...
const Sharemodal = ({ shareUse }) => {
    ...
    return (
        <>
            <div className="modal">
                <div className="min-h-screen bg-gray-800 bg-opacity-70 flex items-center justify-center">
                    <div className="bg-gray-100 w-full mx-4 p-4 rounded-xl md:w-1/2 lg:w-1/3">
                        <div
                            className="flex justify-between items center border-b border-gray-200 py-3"
                        >
                            <div className="flex items-center justify-center">
                                <p className="text-xl font-bold text-gray-800">Share Post</p>
                            </div>
                        ...
                        <div className="my-4">
                            ...
                            <div className="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
                                ...
                                <input className="w-full outline-none bg-transparent" type="text" placeholder="link" value="AskLasalle.com" />
