...
const DoesNotExist = () => {
    ...
    return ( 
        <div>
            <div className="message" class="w-2/3 m-auto mt-44 rounded-2xl p-8 flex gap-6 items-center justify-center bg-gradient-to-b from-teal to-mint">
                <div className="icon">
                    <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="100px" height="100px" viewBox="0 0 106.059 106.059">
                        <g>
                ...
                <div className="text" class="text-2xl font-bold">
                    <h1>Oops! This page does not exist!</h1>
                </div>
            </div>
            
            <div className="back" class="w-2/3 flex m-auto mt-10 justify-center">
                <p onClick={() => navigate(-1)} class="underline font-semibold cursor-pointer">Go back</p>
            </div>
        </div>
     );
}
